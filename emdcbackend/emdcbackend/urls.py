...
from .views.scoresheets import create_score_sheet, edit_score_sheet, scores_by_id, delete_score_sheet, \
    ...
    create_scoresheets_for_existing_teams
...
urlpatterns = [
    ...
    path('api/scoreSheet/createForExistingTeams/', create_scoresheets_for_existing_teams, name='create_scoresheets_for_existing_teams'),
