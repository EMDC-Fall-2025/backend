...
This is a standalone script, not a Django test. Run it directly with:
    python manage.py shell < emdcbackend/test/test_shared_password.py
    OR
    python -m emdcbackend.test.test_shared_password

Note: This file is NOT discovered by Django's test runner because it doesn't
contain test classes. However, to prevent any module-level code execution
during test discovery, the main logic is wrapped in a main() function.
"""
import os
import sys
import django
